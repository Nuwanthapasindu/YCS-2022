...
Route::post('/auth/email-verification', [AuthController::class, 'emailVerification']);
Route::post('/auth/forgot-password-update/{token}', [AuthController::class, 'ForgotPasswordUpdate']);

Route::group(['middleware' => ['auth:api']], function () {
    Route::get('/user/all', [GuestRequestController::class, 'AllUsers']);
    Route::get('all-sections', [GuestRequestController::class, 'AllSections']);
