                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://tesaqm.stripocdn.email/content/guids/CABINET_67e080d830d87c17802bd9b4fe1c0912/images/55191618237638326.png"
                                                                        alt
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#67041c">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#2CB543;background:#67041c;border-width:0px;display:inline-block;border-radius:0px;width:auto"><a
                                                                            href="{{ env('APP_FRONTEND_URL') . 'password-update?token=' }}{{ $data['token'] }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#f8bf06;font-size:20px;border-style:solid;border-color:#67041c;border-width:10px 30px 10px 30px;display:inline-block;background:#67041c;border-radius:0px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">Verify
                                                                            Now</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
